...
static option_t Option[] = {
   ...
   { "Futility Margin (Depth=2)",  true, "600",   "spin",  "min 0 max 3500", NULL },
   { "Futility Margin (Depth=3)",  true, "950",   "spin",  "min 0 max 3500", NULL },
   ...
   //{ "Fruit Extended History Pruning",true, "false", "check", "", NULL },
   //{ "Fruit History Threshold",   true, "15",   "spin",  "min 0 max 100", NULL },
